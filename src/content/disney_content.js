(() => {
  ...
  const BUTTONS = [
    { id: 'dext-left-button', area: 'left', label: 'Left Button', consoleMessage: 'Left button clicked' },
    { id: 'dext-right-button-1', area: 'right', label: 'Right Button 1', consoleMessage: 'Right button 1 clicked' },
    { id: 'dext-right-button-2', area: 'right', label: 'Right Button 2', consoleMessage: 'Right button 2 clicked' }
  ];
...
function addButton(config, host) {
  ...
  if (!container || !host.contains(container)) {
    ...
    const onActivate = (e) => {
      console.log(config.consoleMessage);   // 今はコンソール出力のみ
