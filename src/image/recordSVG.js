(() => {
	...
	function createSVG(width = "120%", height = "120%") {
		//デフォルトは120%でnetflixにフィットさせています。
		...
		style.textContent =
			".cls-637630c1c3a86d32eae6f029-1{fill:none;stroke:currentColor;stroke-miterlimit:10;}";
		...
		svg.appendChild(
			createSVGElement("polygon", {
				class: "cls-637630c1c3a86d32eae6f029-1",
				points:
					"16.77 17.73 21.55 21.55 22.5 21.55 22.5 9.14 21.55 9.14 16.77 12.96 16.77 17.73",
			}),
		);
